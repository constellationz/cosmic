...
gsettings set org.gnome.desktop.interface font-name "Fira Code Medium 10"
gsettings set org.gnome.desktop.interface document-font-name "Fira Code Medium 10"
